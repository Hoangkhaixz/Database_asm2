...
namespace ClothesBadmintonManagent
{
    ...
    {
        string connectionString = @"Data Source=LAPTOP-I70VJAFS\SQLEXPRESS;Initial Catalog=Highs;Integrated Security=True;TrustServerCertificate=True";
        SqlConnection con;
        //SqlCommand cmd;
        SqlDataAdapter adt;
        ...
        private void btn_login_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Không thể kết nối tới SQL Server: " + ex.Message);
            }
