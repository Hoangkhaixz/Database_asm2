...
namespace ClothesBadmintonManagent
{
    public partial class Form6 : Form
    {
        ...
        private string connectionString = @"Data Source=LAPTOP-I70VJAFS\SQLEXPRESS;Initial Catalog=Highs;Integrated Security=True;TrustServerCertificate=True";
        ...
        private void btn_pay_Click(object sender, EventArgs e)
        {
            if (GrView_spUser.SelectedRows.Count > 0) // Kiểm tra xem có dòng nào được chọn không
            {
                ...
                decimal costPrice = Convert.ToDecimal(selectedProductRow.Cells["InputPrice"].Value); // Sử dụng InputPrice làm CostPrice
